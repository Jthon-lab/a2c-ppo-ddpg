...
import copy
class ATARI(object):
    def __init__(self,env_name,env_seed,timelimit,stack_frame=1,action_repeat=4,color=True,image_size=128):
...
#Test Wrapper
'''env = ATARI("BreakoutNoFrameskip-v4",2000,1000,4,4,True,128)
